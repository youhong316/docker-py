...
class UtilsTest(base.BaseTestCase):
    ...
    def test_convert_volume_binds_unicode_bytes_input_py2(self):
    ...
    def test_convert_volume_binds_unicode_bytes_input_py3(self):
    ...
    @pytest.mark.skipif(six.PY3, reason='python 2 specific test')
    def test_convert_volume_binds_unicode_unicode_input_py2(self):
        expected = [unicode('/mnt/지연:/unicode/박:rw', 'utf-8')]
    ...
    @pytest.mark.skipif(six.PY2, reason='python 3 specific test')
    def test_convert_volume_binds_unicode_unicode_input_py3(self):
        expected = ['/mnt/지연:/unicode/박:rw']
